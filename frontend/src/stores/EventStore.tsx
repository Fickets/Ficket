...
import { eventDetail, eventScheduleDto } from '../types/StoreType/EventDetailStore';

export const eventDetailStore = create(
    persist<eventDetail>((set) => ({
        adminId: 0,
        companyId: 0,
        companyName: "",
        stageId: 0,
        ...
        setTicketingStep: (newStep: boolean) => set(() => ({ ticketingStep: newStep })),
        setScheduleId: (newId: number) => set(() => ({ scheduleId: newId })),
        setChoiceDate: (newDate: string) => set(() => ({ choiceDate: newDate })),
        setChoicetime: (newTime: string) => set(() => ({ choiceTime: newTime })),
        ...
        setCompanyName: (newName: string) => set(() => ({ companyName: newName })),
        ...
        setSigungu: (newSigungu: string) => set(() => ({ sigungu: newSigungu })),
        setStreet: (newStreet: string) => set(() => ({ street: newStreet })),
        setEventStageImg: (newImg: string) => set(() => ({ eventStageImg: newImg })),
        ...
        setSubTitle: (newSubTitle: string) => set(() => ({ subTitle: newSubTitle })),
        setTicketingTime: (newTime: string) => set(() => ({ ticketingTime: newTime })),
        setRunningTime: (newTime: number) => set(() => ({ runningTime: newTime })),
