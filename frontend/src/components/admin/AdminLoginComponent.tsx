        ...
        <div className="flex flex-col md:flex-row min-h-screen">
            ...
            <div className="bg-gray-800 text-white md:w-1/3 flex items-center justify-center p-10">
                <div className="text-center">
                    <img src={FicketLogo} alt="Ficket Logo" className="w-20 h-auto mx-auto mb-4" />
            ...
            <div className="flex-1 flex items-center justify-center p-6 bg-white">
                <div className="w-full max-w-md">
                    <form onSubmit={submitBtn} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <div className="mb-4">
                    ...
                    <p className="text-center text-gray-600 text-sm" >
                        관리 계정 관련 내용은<br></br>업체에서 문의해주세요<br></br>업체 담당자 연락처: 010-1234-5205
                    </p>
                </div>
            </div>
        </div>
