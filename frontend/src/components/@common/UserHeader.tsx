    ...
    return (
        ...
        <div>
            ...
            <div className='flex items-center mx-[300px] justify-between'>
                <div className='flex' >
                    <div onClick={LogoClick} className='flex'>
                        ...
                        <p className='text-[50px] font-semibold ml-[5px]'
                        >Ficket</p>
                        {/* 검색창 */}
                    </div>
                ...
                <div className='flex'>
                    ...
                    <button className='ml-[10px]'>마이티켓</button>
                </div>
            </div>
            {/** navBar */}
            <div className='flex mx-[300px] mt-[20px]'>
                ...
                <button className='mr-[50px] text-[16px] font-sans font-medium ' value={2}>
                    스포츠
                </button>
                <button className='mr-[50px] text-[16px] font-sans font-medium ' value={3}>
                    전시/행사
                </button>
                <button className='mr-[50px] text-[16px] font-sans font-medium' value={4}>
                    클래식/무용
                </button>
