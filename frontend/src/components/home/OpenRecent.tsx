...
const OpenRecent = () => {
    ...
    const getOpenRecent = async () => {
        try {
            const genre = null;
            const data = await openRecent(genre);
            setopen6(data);
    ...
    return (
        <div className="">
            ...
            <div className="hidden md:block">
                <div>
                    <h1 className="font-medium text-[35px] mb-[20px] mt-[100px] ml-[300px]">티켓오픈</h1>
                </div>
                {/* 첫 번째 줄 */}
                ...
                <div className="flex justify-center items-center mt-[20px]">
                    <button
                        className=" text-[24px] font-medium border border-2 rounded-full w-[250px] "
            ...
            <div className="block md:hidden scrollbar-hide overflow-y-hidden">
                <div className="flex mx-[40px]">
                    <div className="flex flex-col items-center w-1/3" onClick={goGenreTicket}>
