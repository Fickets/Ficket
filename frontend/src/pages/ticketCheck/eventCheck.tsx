...
const EventCheckPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <Helmet>
        <title>Ficket - 티켓 검사</title>
      </Helmet>
      <img src={Logo} alt="" className="w-[140px] mt-[120px]" />
      <div>
        <p className="text-[40px] font-medium">Ficket 티켓 검사</p>
      </div>

      <input
        className="mt-[150px] w-[300px] border border-black rounded "
        type="text"
        id="userInput"
      ...
      <div className="flex mt-[30px] items-center justify-center  w-[400px] ">
        <button
          onClick={goManager}
          className="rounded-lg m-[20px] font-regular text-[20px] border-4 border-[#666666] w-[130px] h-[130px]"
        >
          관리자 확인
        </button>
        <button
